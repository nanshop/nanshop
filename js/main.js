...
var programsData = [
    {
       ...
       rightDom: '<div class="l-layer__content -tight"><div class="m-member"> <h1 class="m-member__name">A Space Odyssey</h1> <p class="m-member__text">' + 'self-published photo book </p> <p class="m-member__text">'+ '<span class="m-label -margin-top">time:</span> 2019</p><p class="m-member__text">' + '<span class="m-label">location:</span> Italy, England</p><p class="m-member__text">'+ '<span class="m-label -margin-top">photographer:</span> yinxilu</p><p class="m-member__text">' + '<span class="m-label">editor:</span> yinxilu</p><p class="m-member__text">' + '<span class="m-label">book designer:</span> yinxilu</p><p class="m-member__text -margin-top">' + '<span class="underline">about</span>  </p><p class="m-member__text">A Space Odyssey is a series of photography along my architectural journey this year. Those photographies each unfolds the unseen atmosphere of a certain space, focusing on the unabashed emotion and a tension between strangeness and familiarity. Those seemingly private moments of a public or semi- open space evoke my attachment of the space, the abstractions in this photography reveal my interest and studies in colours and light.' + '</p>' + '</div></div>',
  },
    {
  ...
  },
    {
        ...
        rightDom: '<div class="l-layer__content -tight"><div class="m-member"> <h1 class="m-member__name">Atlas</h1> <p class="m-member__text">' + 'self-published photo book </p> <p class="m-member__text">'+ '<span class="m-label -margin-top">time:</span> 2019</p><p class="m-member__text">' + '<span class="m-label">location:</span> Rotterdam, The Netherlands</p><p class="m-member__text">'+ '<span class="m-label -margin-top">photographer:</span> yinxilu</p><p class="m-member__text">' + '<span class="m-label">editor:</span> yinxilu</p><p class="m-member__text">' + '<span class="m-label">book designer:</span> yinxilu</p><p class="m-member__text -margin-top">' + '<span class="underline">about</span>  </p><p class="m-member__text">Atlas is a photography portfolio for atelier Yinxi, it summarised the recent works for the spatial representation and documentation.' + '</p>' + '</div></div>',
  },
    {
...
var archivesData = [
  ...
  },
    {
        ...
        detailPic: ['/images/archives/archive b002_Encounter Barbican/cover page.jpg', '/images/archives/archive b002_Encounter Barbican/Archi-26.JPG', '/images/archives/archive b002_Encounter Barbican/Archi-27.JPG', '/images/archives/archive b002_Encounter Barbican/Archi-28.JPG', '/images/archives/archive b002_Encounter Barbican/Archi-29.JPG', '/images/archives/archive b002_Encounter Barbican/Archi-30.JPG', '/images/archives/archive b002_Encounter Barbican/Archi-31.JPG'],
         rightDom: '<div class="l-layer__content -tight"><div class="m-member"> <h1 class="m-member__name">Encounter Barbican</h1>  <p class="m-member__text">' + 'self-published photo book</p> <p class="m-member__text">' + ' 2018 / London, England</p> <p class="m-member__text">' + '<span class="m-label -margin-top">photographer:</span> Yinxi Lu</p><p class="m-member__text">' + '<span class="m-label">editor:</span> Yinxi Lu</p><p class="m-member__text">' + '<span class="m-label">book designer:</span> Yinxi Lu</p><p class="m-member__text -margin-top">' + '<span class="underline">about</span>  </p><p class="m-member__text">“Encounter Barbican” is a series of a self-published photographic essay I made for my journey in London and for my graduation thesis of designing a concert hall on the site of Barbican. Each image captures the fragment of the journey while I walking towards Barbican Centre in the City of London. I tried to understand the urban context and the city through these fragments. As Aldo Rossi says: “One can say that the city itself is the collective memory of its people, and like memory, it is associated with objects and places. The city is the locus of collective memory. This relationship between the locus and the citizenry then becomes the city’s predominant image, both of architecture and of landscape, and as certain artefacts become part of its memory, new ones emerge.”' + '</p>' + '</div></div>',
  },
    {
...
var memberObject = {
    'yinxi-lu': {
        ...
        bgcolor: '#40ae49',
        rightDom: '<div class="l-layer__content -tight"><div class="m-member"> <h1 class="m-member__name">Yinxi Lu </h1> <p class="m-member__title">-architect / visual designer / photographer </p> <p class="m-member__text">' +
    ...
    'fred-zhang': {
        ...
        bgcolor: '#00aeef',
        rightDom: '<div class="l-layer__content -tight"><div class="m-member"> <h1 class="m-member__name">fred zhang </h1> <p class="m-member__title">-landscape architect / photographer </p> <p class="m-member__text">' +
    ...
    'eki-ong': {
        ...
        bgcolor: '#f9e108',
        rightDom: '<div class="l-layer__content -tight"><div class="m-member"> <h1 class="m-member__name">eki ong </h1> <p class="m-member__title">-designer / architect / independent curator  </p> <p class="m-member__text">' +
    ...
    'sebastiano-pibia': {
        ...
        bgcolor: '#ecc7de',
        rightDom: '<div class="l-layer__content -tight"><div class="m-member"> <h1 class="m-member__name">sebastiano pibia </h1> <p class="m-member__title">-designer / architect </p> <p class="m-member__text">' +
